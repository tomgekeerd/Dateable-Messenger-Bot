                                ...
                                case "blockChat":
                                    ...
                                    pg.connect(process.env.DATABASE_URL, (err, client, done) => {
                                        ...
                                        getDetails.on('row', function(row) {
                                            ...
                                            const checkQuery = client.query(`INSERT INTO blocked_users (fb_id, blocked) VALUES(${row.responder}, ${row.initiator}) ON CONFLICT (blocked_users) DO UPDATE SET fb_id=fb_id;`)
                                            checkQuery.on('end', () => {
